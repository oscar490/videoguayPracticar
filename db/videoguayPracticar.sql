...
INSERT INTO alquileres (socio_id, pelicula_id, created_at, devolucion)
    VALUES (1, 1, current_timestamp - '4 days'::interval, current_timestamp - 'P3D'::interval)
         , (1, 2, current_timestamp - '2 days'::interval, null)
         , (1, 3, current_timestamp - '1 days'::interval, current_timestamp)
         , (3, 1, current_timestamp - '3 days'::interval, current_timestamp - 'P1D'::interval);
